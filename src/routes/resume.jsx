...
export default function Resume() {
  ...
  return (
    <div className="resume">
      ...
      <img src="./images/resume_thumbnail.png" className='resume-thumbnail d-block pb-3 mx-auto' alt="resume thumbnail" data-bs-toggle="modal" data-bs-target="#exampleModal" />
        ...
        <div className="modal-dialog modal-xl">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <img src="./images/resume_thumbnail.png" className='d-block mx-auto' alt="resume thumbnail" />
            </div>
